...
const MOCK_TRANSACTIONS = [
  { id: 'TXN-001', customer: 'Alice Doe', amount: 1500, method: 'UPI', status: 'Success', date: '2026-03-10', staff: 'Staff A' },
  { id: 'TXN-002', customer: 'Bob Smith', amount: 450, method: 'Card', status: 'Pending', date: '2026-03-10', staff: 'Staff B' },
  { id: 'TXN-003', customer: 'Charlie', amount: 12000, method: 'Bank Transfer', status: 'Failed', date: '2026-03-09', staff: 'Staff A' },
  { id: 'TXN-004', customer: 'Dave L.', amount: 999, method: 'Wallet', status: 'Success', date: '2026-03-09', staff: 'Staff C' },
  { id: 'TXN-005', customer: 'Eve', amount: 3200, method: 'UPI', status: 'Success', date: '2026-03-08', staff: 'Staff B' },
];
